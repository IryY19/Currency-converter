<br>
<br>
<header  class="alert alert-dark" role="alert" style=" padding: 15px; opacity: 0.7;">
    <div class="container">
    
        <div class="row">
            <div class="col-md-1 text-right" style="margin: 0; padding: 0;">
                <img src="http://pngimg.com/uploads/euro_sign/euro_sign_PNG21561.png" style="width: 40px; height: auto;">
            </div>
            <div class="col-md text-left"  style="margin: 0; padding: 7px;">
